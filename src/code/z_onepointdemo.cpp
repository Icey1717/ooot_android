...
s32 OnePointCutscene_SetInfo(GlobalContext* globalCtx, s16 camIdx, s16 csId, Actor* actor, s16 timer)
{
	...
	switch(csId)
	{
		...
		case 2200:
		{
			...
			if((sp82 > 0) && (sp82 < 320) && (sp7E > 0) && (sp7E < 240) && (sp80 > 0) && (sp80 < 320) && (sp7C > 0) && (sp7C < 240) && !OnePointCutscene_BgCheckLineTest(&globalCtx->colCtx, &actor->focus.pos, &player->actor.focus.pos))
			{
		...
		case 2210:
			...
			D_801213B4[0].eyeTargetInit.y = D_801213B4[1].eyeTargetInit.y = D_801213B4[2].eyeTargetInit.y = D_801213B4[2].atTargetInit.y = BINANG_TO_DEGF(spD0.yaw);
		...
		case 3050:
			...
			D_8012013C[D_801202FC - 3].pos.x += (D_8012013C[D_801202FC - 2].pos.x - D_8012013C[D_801202FC - 3].pos.x) / 2;
			D_8012013C[D_801202FC - 3].pos.y += (D_8012013C[D_801202FC - 2].pos.y - D_8012013C[D_801202FC - 3].pos.y) / 2;
			D_8012013C[D_801202FC - 3].pos.z += (D_8012013C[D_801202FC - 2].pos.z - D_8012013C[D_801202FC - 3].pos.z) / 2;
			D_8012021C[D_801202FC - 3].pos.x += (D_8012021C[D_801202FC - 2].pos.x - D_8012021C[D_801202FC - 3].pos.x) / 2;
			D_8012021C[D_801202FC - 3].pos.y += (D_8012021C[D_801202FC - 2].pos.y - D_8012021C[D_801202FC - 3].pos.y) / 2;
			D_8012021C[D_801202FC - 3].pos.z += (D_8012021C[D_801202FC - 2].pos.z - D_8012021C[D_801202FC - 3].pos.z) / 2;
...
s16 OnePointCutscene_EndCutscene(GlobalContext* globalCtx, s16 camIdx)
{
	...
	{
		osSyncPrintf("onepointdemo camera[%d]: delete timer=%d next=%d\n", camIdx, (s32)globalCtx->cameraPtrs[camIdx]->timer, globalCtx->cameraPtrs[camIdx]->parentCamIdx);
