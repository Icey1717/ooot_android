...
static BlockConfig sBlocks[] = {
    {{{660.0f, 460.0f, 660.0f}, {660.0f, 457.0f, 540.0f}, {780.0f, 454.0f, 540.0f}}, 0x00, 0x00, 0x03, 0xFF, PUSHBLOCK_LARGE_START_ON, 0x0000},
    {{{-605.0f, -820.0f, -290.0f}, {-365.0f, -905.0f, -290.0f}, {-365.0f, -905.0f, -290.0f}}, 0x00, 0x03, 0x00, 0xFF, PUSHBLOCK_SMALL_START_ON, 0x0000}};
...
void ObjMakeoshihiki_Init(Actor* thisx, GlobalContext* globalCtx)
{
	...
	if(Actor_SpawnAsChild(&globalCtx->actorCtx, thisx, globalCtx, ACTOR_OBJ_OSHIHIKI, spawnPos->x, spawnPos->y, spawnPos->z, 0, block->rotY, 0, ((block->color << 6) & 0xC0) | (block->type & 0xF) | 0xFF00) == NULL)
	{
