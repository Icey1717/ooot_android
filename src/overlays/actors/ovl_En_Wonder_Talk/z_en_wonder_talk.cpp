...
ActorInit En_Wonder_Talk_InitVars = {
    ACTOR_EN_WONDER_TALK, ACTORCAT_PROP, FLAGS, OBJECT_GAMEPLAY_KEEP, ACTOR_FACTORY(EnWonderTalk), (ActorFunc)EnWonderTalk_Init, (ActorFunc)EnWonderTalk_Destroy, (ActorFunc)EnWonderTalk_Update, NULL, (ActorFunc)EnWonderTalk_Reset,
};
	...
	if(pthis->unk_156 == Message_GetState(&globalCtx->msgCtx) && Message_ShouldAdvance(globalCtx))
	{
		...
		switch(pthis->unk_150)
		{
			...
			case 3:
				...
				if(pthis->unk_164 == 0)
				{
					Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_POH, pthis->actor.world.pos.x, pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, 0, 0, 2);
					pthis->unk_164 = 1;
				}
			...
			case 5:
				...
				if(pthis->unk_164 == 0)
				{
					Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_POH, pthis->actor.world.pos.x, pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, 0, 0, 3);
					pthis->unk_164 = 1;
				}
				pthis->actionFunc = func_80B391CC;
				break;
